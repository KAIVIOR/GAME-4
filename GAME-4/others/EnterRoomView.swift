...
//    
//    @State private var currentUserData = Auth.auth().currentUser
//    @State private var userPhotoURL = URL(string: "")
//    @State private var userName = "我只是用來測試的帥哥"
//    
...
//                    Button(action:
//                    {
//                      //  createRoom(start: true, player1: "\(userName)", player2: "", URL_player1: "\(cur)", URL_player2: "", quantity: 1, preparedQuantity: 0)
...
//                        db.collection("").whereField("name", isEqualTo: "\(SearchRoomName)").getDocuments { snapshot, error in
...
//                
//                print("myurl\(currentUserData?.photoURL)")
